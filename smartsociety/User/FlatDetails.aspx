<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlatDetails.aspx.cs" Inherits="smartsociety.User.FlatDetails" %>
...
<body>
    ...
    <div id="main">
            ...
            <div class="content-area">
                ...
                <div class="contentbox">
                    ...
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.aspx">Home</a><a href="#">Apartment</a><a href="#">Flat Details</a><a href="#">View Details</a>Details</p>
                        <h1>Flat Details</h1>
                    	<p>This page is for users to see the detailed information about a particular Flat.</p>
							...
							<input name="CreateNew" type="button" class="primarybuttons" onclick="cnfrmtn = confirm('Do you want to Edit?'); if (cnfrmtn) { window.location = 'EditFlatDetails.aspx'; }" value="Edit" />
        	...
        	&nbsp;
          <!--  <a href="#">Copyright</a> to Mak Production</div>-->
        <div id="footer"></div>
    </form>
</body>
</html>
