<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="smartsociety.Login" %>
            ...
            <div class="content-area">
            	<div id="header">
                	<a href="Index.aspx" class="logo">
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/logo16.gif" Height="73px" Width="958px" /></a>
				</div>
                <div id="navbar">
										...
										<tbody>
											...
											<tr class="odd">
												<th colspan="2" class="column1">
                                                    <asp:Button ID="Button2" class="primarybuttons" runat="server" Text="Sign Up" OnClick="Button2_Click" />   
                                                    <asp:Button ID="Button1" class="primarybuttons" runat="server" Text="Sign In" OnClick="Button1_Click1" /></th>
