<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AptDetailsView.aspx.cs" Inherits="smartsociety.Admin.AptDetailsView" %>
...
<body>
    ...
    <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                	<a href="Index.aspx" class="logo"><img src="Images/AMS_Logo.jpg" title="User Logo" /></a>
               ...
               <div id="navbar">
                ...
                <div class="contentbox">
                    ...
                    <div class="leftmenu">
						<ul>
							<li>Society
								<ul>
									<li>
                                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton2_Click">View Society Details</asp:LinkButton></li>
									<li>
                                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton3_Click">View Flat Details</asp:LinkButton></li>
                                    <li>
                                        <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton4_Click">View Common Rentals</asp:LinkButton></li>
								</ul>
							</li>
						</ul>
                    </div>
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.aspx">Home</a><a href="#">Society</a>Details<a href="#"></a>View</p>
                        <h1>&nbsp;Society Details.This page is for users to view Apartment Details.</h1>
                    	</div>
                    ...
                    <asp:Button ID="Button1" class="primarybuttons" runat="server" Text="Edit" OnClick="Button1_Click" />
