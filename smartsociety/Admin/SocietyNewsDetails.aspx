<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SocietyNewsDetails.aspx.cs" Inherits="smartsociety.Admin.SocietyNewsDetails" %>
...
<body>
    ...
    <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="76px" Width="956px" />
				</div>
                 <div id="navbar">
