<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="smartsociety.Admin.Index" %>
    ...
    <form id="form1" runat="server">
     <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="74px" Width="953px" />
				</div>
                <div id="navbar">
                ...
                <div class="contentbox">
                    <table width="100%">
                    	<tr>
                        	<td width="52%">
                                <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo7.jpg" /></td>
                            <td width="48%">
                            	<span class="welcome">Hello!! Admin. Welcome to Smart Society System</span>
