<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSocietyNews.aspx.cs" Inherits="smartsociety.Admin.ViewSocietyNews" %>
            ...
            <div class="content-area">
                ...
                <div class="contentbox">
                    <div class="leftmenu">
                    	<ul>
							<li>Types of News
								<ul>
									<li>
                                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Notices</asp:LinkButton>
                                    </li>
									<li>
                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">Events</asp:LinkButton>
                                    </li>
								</ul>
							</li>
						</ul>
                    ...
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.aspx">Home</a><a href="#">News</a> <a href="#">Society News</a>View News</p>
                   <h1>View News.This Page is for Viewing different typesNews </h1>
               </div>     
                     <div>   <asp:GridView ID="GridView1"   class="datatable1" runat="server" Height="20px" Width="702px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" DataKeyNames="SoNewsID">
                         ...
                         <asp:TemplateField>
                            <ItemTemplate>
                               &nbsp;&nbsp;&nbsp; <%#Container.DataItemIndex+1 %>
                                ...
                                <asp:BoundField DataField="SoNewsID" HeaderText="Society News ID" InsertVisible="False" ReadOnly="True" SortExpression="SoNewsID" />
