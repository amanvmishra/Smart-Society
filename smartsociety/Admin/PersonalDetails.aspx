<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonalDetails.aspx.cs" Inherits="smartsociety.Admin.PersonalDetails" %>
    ...
    <form id="form1" runat="server">
      <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="77px" Width="959px" />
				</div>
                <div id="navbar">
                        	...
                        	<table class="dataTable">
                            	...
                            	<tbody>
                                    ...
                                    <td width="150px">
                                        ...
                                        <th class="column1" width="150px">&nbsp;</th>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr class="odd">
