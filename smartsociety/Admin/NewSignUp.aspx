<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewSignUp.aspx.cs" Inherits="smartsociety.Admin.NewSignUp" %>
    ...
    <form id="form1" runat="server">
     <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="76px" Width="958px" />
				</div>
                <div id="navbar">
                ...
                <div class="contentbox">
                    ...
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.aspx">Home</a><a href="#"> Administration</a> <a href="#">User Management</a>New SignUP Users</p>
                        <h1>List All UsersThose who had registered but not yet approved by Admin.</h1>
               </div>     
                    ...
                    <div>
                           <asp:Button ID="Button1" class="primarybuttonl" runat="server" Text="Create New" OnClick="Button1_Click" />
