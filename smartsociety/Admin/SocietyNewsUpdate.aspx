<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SocietyNewsUpdate.aspx.cs" Inherits="smartsociety.Admin.SocietyNewsUpdate" %>
...
<body>
  ...
  <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="77px" Width="956px" />
				</div>
                 <div id="navbar">
                ...
                <div class="contentbox">
                    	...
                    	<ul>
							<li>News
								<ul>
									...
									<li>
                                        <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">updating Society News</asp:LinkButton></li>
									<li>
                    ...
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.html">Home</a><a href="#">News</a> <a href="#">Society News</a>Update Society News</p>
                        <h1>Update Society News. This page is for updating society news.</h1>
