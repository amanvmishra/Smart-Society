<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListAllFlats.aspx.cs" Inherits="smartsociety.Admin.ListAllFlats" %>
...
<body>
    ...
    <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="78px" Width="959px" />
				</div>
                <div id="navbar">
                ...
                <div class="contentbox">
 					...
 					<ul>
							<li>Society
								<ul>
									<li>
                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click1">View Society Details</asp:LinkButton>  </li>
									<li>
                    ...
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.aspx">Home</a><a href="#">Society</a><a href="#">Flat Details</a>View Details</p>
