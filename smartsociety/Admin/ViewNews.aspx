<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewNews.aspx.cs" Inherits="smartsociety.Admin.ViewNews" %>
...
<body>
    ...
    <div id="main">
            ...
            <div class="content-area">
            	<div id="header">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Admin/Images/logo16.gif" Height="76px" Width="955px" />
				</div>
                <div id="navbar">
                ...
                <div class="contentbox">
                    ...
                    <div class="maincolumn">
                    	<p class="breadcrumb"><a href="Index.aspx">Home</a><a href="#">News</a> <a href="#">All News</a>View News</p>
                   List All UsersThis page is for users to list all user information.</h1>
                    ...
                    <div>
                        <asp:Button ID="Button1" class="primarybuttonl" runat="server" Text="Send SMS" OnClick="Button1_Click" />
